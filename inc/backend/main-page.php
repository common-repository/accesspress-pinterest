...
<div class="apsp-outer-wrapper">
    <div class='apsp-main-wrapper'>
        <div class="apsp-setting-header clearfix">
            <div class="apsp-headerlogo">
                <img src="<?php echo esc_attr(APSP_IMAGE_DIR); ?>/logo.png" alt="<?php esc_attr_e('PI Button', 'accesspress-pinterest' ); ?>" />
            </div>
            <div class="apsp-right-header-block">
                <div class="apsp-header-icons">
                    <p><?php _e('Follow us for new updates', 'accesspress-pinterest' ) ?></p>
                ...
                <div class="apsp-header-title">
                    <?php _e('PI Button', 'accesspress-pinterest' ); ?>
                </div>
            </div>
        </div>
        ...
        if (isset($_GET['message'])) {
           if($_GET['message'] == 1){ ?>
            <div class="apsp-message">
                <p> <?php _e('Settings Saved Successfully.', 'accesspress-pinterest' ); ?></p>
            </div>
          <?php }else{ ?>
            <div class="apsp-message">
                <p> <?php _e('Settings restored Successfully.', 'accesspress-pinterest' ); ?></p>
            </div>
          <?php }
         } ?>
        ...
        <div class="apsp-backend-wrapper clearfix">
            <ul class="apsp-setting-tabs">
                ...
                <li><a href="javascript:void(0)" id="apsp-about" class="apsp-tabs-trigger"><i class="fa fa-key"></i><?php _e('More WordPress Stuff', 'accesspress-pinterest' ); ?></a></li>
            </ul>
            ...
            <div class="apsp-form-wrap">
                <form action="<?php echo admin_url() . 'admin-post.php' ?>" method='post'>
                    <div class='apsp-tab-contents apsp-active-tab' id='tab-apsp-pinit-hover-settings'>
                        ...
                        <input type='checkbox' id='apsp_js_enabled' name='apsp-pinit-js' <?php if (isset($options['js_enabled']) && $options['js_enabled'] == 'on') { ?> checked='checked'; <?php } ?>/> <label for='apsp_js_enabled'><?php _e('Enable Pin It hover button over images.', 'accesspress-pinterest' ); ?></label>
                        ...
                        <div class="apsp-display-settings" <?php if(isset($options['js_enabled']) && $options['js_enabled'] == 'on'){ ?> style='display:block;' <?php }else{ ?> style='display:none;' <?php } ?>>
                            ...
                            if (!empty($taxonomies)) { ?>
                                ...
                                foreach ($taxonomies as $key => $value) { ?>
                                    ...
                                    <p><input type="checkbox" id="apspp_<?php echo $value->name; ?>" value="<?php echo $value->name; ?>" name="apsp_display_settings[display_options][]" <?php if (isset($options['display_options']) && is_array($options['display_options']) && in_array($value->name, $options['display_options'])) { echo "checked='checked'"; } ?> ><label for="apsp_<?php echo $value->name; ?>"><?php _e($name, 'accesspress-pinterest'); ?></label></p>
                                    <?php
                                }
                            } ?>
                        </div>

                        <h3 class="apsp-sub-title"><?php _e('Button Appearance Settings', 'accesspress-pinterest' ); ?></h3>
                        ...
                        <div class="apsp-rectangular-options" <?php if ($options['shape'] == 'rectangular') { ?> style="display:block;" <?php } else { ?>style='display:none;' <?php } ?>>
                            ...
                            <div class="apsp-select-wrapper">
                                ...
                                <select name='apsp-pinterest-rectangle-lang' id='apsp-pinterest-rectangle-lang'>
                                    ...
                                    <option value='hi' <?php selected($options['language'], 'hi'); ?> ><?php _e('Hindi', 'accesspress-pinterest'); ?></option>
    ...
    <div class='apsp-add-wrapper'>
        <a href="https://accesspressthemes.com/wordpress-plugins/accesspress-pinterest-pro/" target="_blank" ><img src="<?php echo esc_attr(APSP_IMAGE_DIR); ?>/promo-top.png" alt="promo-top"></a>
        <div class="apsp-promo-buttons"><a target="_blank" href="http://demo.accesspressthemes.com/wordpress-plugins/accesspress-pinterest-pro"><img src="<?php echo esc_attr(APSP_IMAGE_DIR); ?>/demo-btn.png" alt="demo link"></a><a target="_blank" href="https://accesspressthemes.com/wordpress-plugins/accesspress-pinterest-pro/"><img src="<?php echo esc_attr(APSP_IMAGE_DIR); ?>/upgrade-btn.png" alt="upgrade link"></a></div>
        <a href="https://accesspressthemes.com/wordpress-plugins/accesspress-pinterest-pro/" target="_blank" ><img src="<?php echo esc_attr(APSP_IMAGE_DIR); ?>/promo-bottom.png" alt="promo-bottom"></a>
        <div class="apsp-promo-buttons"><a target="_blank" href="http://demo.accesspressthemes.com/wordpress-plugins/accesspress-pinterest-pro"><img src="<?php echo esc_attr(APSP_IMAGE_DIR); ?>/demo-btn.png" alt="demo link"></a><a target="_blank" href="https://accesspressthemes.com/wordpress-plugins/accesspress-pinterest-pro/"><img src="<?php echo esc_attr(APSP_IMAGE_DIR); ?>/upgrade-btn.png" alt="upgrade link"></a></div>
